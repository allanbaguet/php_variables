...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                ...
                <p class="text-center fs-4">Créer trois variables <strong>lastname , firstname et age</strong> et les initialiser avec les valeurs de votre choix.
                    <strong>Attention age est de type entier</strong>. Afficher leur contenu.
                </p>
            </div>
        </div>
    </div>
    ...
    <main>
        <div>
            ...
            <p>
                <?="Je m'appelle" . " " . $lastname . " " . $firstname . " " . "j'ai" . " " . $age . " ans"?>
            </p>
        </div>
    </main>
