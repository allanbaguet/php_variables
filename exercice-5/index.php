    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                ...
                <p class="text-center fs-4">Créer une variable de type int. L'initialiser avec <strong>rien</strong>. Afficher sa valeur.
    ...
    <main>
        <div>
            <p>
                <?php
                $int_var = NULL;     
                    echo "La valeur première est : " . $int_var . "<br>";
                ?>
                <?="La valeur première est : " . $int_var . "<br>"?>
                <?php
                $int_var = 42; 
                    echo "La nouvelle valeur est : " . $int_var . "<br>";
                ?>            
                <?="La nouvelle valeur est : " . $int_var . "<br>"?>   
            </p>
        </div>
    </main>
