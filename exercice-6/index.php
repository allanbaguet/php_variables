    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                ...
                <p class="text-center fs-4">Créer une variable <strong>name</strong> et l'initialiser avec la valeur de votre choix.
                    Afficher : Bonjour + <strong>name</strong> + , comment vas tu ?.</p>
            </div>
        </div>
    </div>
