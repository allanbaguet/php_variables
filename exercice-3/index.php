...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                ...
                <p class="text-center fs-4">Créer une variable <strong>km</strong>. L'initialiser à 1. Afficher son contenu. <br>
                    Changer sa valeur par 3. Afficher son contenu. <br>
                    Changer sa valeur par 125. Afficher son contenu. <br></p>
            </div>
        </div>
    </div>
    ...
    <main>
        <div>
            ...
            <?php $km = 125; ?>
            <p><?php echo $km; ?></p>
            <!-- // nl2br($km."\n"); ->  nl2br sert au retour à la ligne -> c'est une balise  -->
            <br>
            </p>
            <p>
                <?= nl2br($km . "\n") ?>
