    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                ...
                <p class="text-center fs-4">Créer trois variables <strong>lastname , firstname</strong> et <strong>age</strong> et les initialiser
                    avec les valeurs de votre choix. <strong>Attention age est de type entier</strong> .
                    Afficher : Bonjour + <strong>lastname + firstname</strong> + , tu as + <strong>age</strong> + ans.</p>
            </div>
        </div>
    </div>
